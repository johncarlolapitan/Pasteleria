...
namespace Pastelería.MAINC
{
    class cashierMainC
    {
        ...
        public bool Insert(cashierGETSET dc)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO tbl_cashier (type, name, email, contact, address, added_date, added_by) VALUES (@type, @name, @email, @contact, @address, @added_date, @added_by)";
        ...
        public bool Update(cashierGETSET dc)
        {
            //SQL Connection for Database Connection
            SqlConnection conn = new SqlConnection(myconnstrng);
            ...
            try
            {
                ...
                string sql = "UPDATE tbl_cashier SET type=@type, name=@name, email=@email, contact=@contact, address=@address, added_date=@added_date, added_by=@added_by WHERE id=@id";
        ...
        public bool Delete(cashierGETSET dc)
        {
            ...
            try
            {
                ...
                string sql = "DELETE FROM tbl_cashier WHERE id=@id";
        ...
        public DataTable Search(string keyword)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tbl_cashier WHERE id LIKE '%"+keyword+"%' OR type LIKE '%"+keyword+"%' OR name LIKE '%"+keyword+"%'";
        ...
        public cashierGETSET SearchDealerCustomerForTransaction(string keyword)
        {
            //Create an object for DeaCustBLL class
            cashierGETSET dc = new cashierGETSET();
            ...
            try
            {
                ...
                string sql = "SELECT name, email, contact, address from tbl_cashier WHERE id LIKE '%"+keyword+"%' OR name LIKE '%"+keyword+"%'";
        ...
        public cashierGETSET GetDeaCustIDFromName(string Name)
        {
            ...
            try
            {
                ...
                string sql = "SELECT id FROM tbl_cashier WHERE name='"+Name+"'";
