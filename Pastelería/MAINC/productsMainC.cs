...
namespace Pastelería.MAINC
{
    class productsMainC
    {
        ...
        public bool Insert(productsGETSET p)
        {
        ...
        public bool Update(productsGETSET p)
        {
            ...
            try
            {
                ...
                String sql = "UPDATE tbl_products SET name=@name, category=@category, rate=@rate, qty=@qty, added_date=@added_date, added_by=@added_by WHERE product_id=@product_id";
        ...
        public bool Delete(productsGETSET p)
        {
            ...
            try
            {
                ...
                String sql = "DELETE FROM tbl_products WHERE product_id=@product_id";
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tbl_products WHERE product_id LIKE '%" + keywords + "%' OR name LIKE '%" + keywords + "%' OR category LIKE '%" + keywords + "%'";
        ...
        public productsGETSET GetProductsForTransaction(string keyword)
        {
            ...
            try
            {
                ...
                string sql = "SELECT name, rate, qty FROM tbl_products WHERE product_id LIKE '%" + keyword + "%' OR name LIKE '%" + keyword + "%'";
        ...
        public productsGETSET GetProductIDFromName(string ProductName)
        {
            ...
            try
            {
                ...
                string sql = "SELECT product_id FROM tbl_products WHERE name='" + ProductName + "'";
