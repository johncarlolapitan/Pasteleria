...
namespace Pastelería.MAINC
{
    class userMainC
    {
        ...
        public bool Insert(userGETSET u)
        {
        ...
        public bool Update(userGETSET u)
        {
            bool isSuccess = false;
            SqlConnection conn = new SqlConnection(myconnstrng);
            ...
            try
            {
                string sql = "UPDATE tbl_users SET first_name=@first_name, last_name=@last_name, email=@email, username=@username, password=@password, contact=@contact, address=@address, gender=@gender, user_type=@user_type, added_date=@added_date, added_by=@added_by WHERE user_id=@user_id";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        public bool Delete(userGETSET u)
        {
            bool isSuccess = false;
            SqlConnection conn = new SqlConnection(myconnstrng);
        ...
        public userGETSET GetIDFromUsername (string username)
        {
